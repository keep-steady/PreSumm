...
#### BertAbs train 코드
```
python train.py -mode train -accum_count 5 -batch_size 64 -bert_data_path ../data/already_converted_data/cnndm -dec_dropout 0.1 -log_file ../logs/abs -lr 0.05 -model_path ../models/abs -save_checkpoint_steps 2000 -seed 777 -sep_optim false -train_steps 200000 -use_bert_emb true -use_interval true -warmup_steps 8000  -visible_gpus 0,1 -max_pos 512 -report_every 50 -enc_hidden_size 512  -enc_layers 6 -enc_ff_size 2048 -enc_dropout 0.1 -dec_layers 6 -dec_hidden_size 512 -dec_ff_size 2048 -encoder baseline -task abs
```

#### BertAbs valid 코드
```
python train.py -task abs -mode validate -batch_size 3000 -test_batch_size 500 -bert_data_path ../data/already_converted_data/cnndm -log_file ../logs/val_abs_bert_cnndm -model_path ../models/abs/model_step_4000.pt -sep_optim true -use_interval true -visible_gpus 1 -max_pos 512 -max_length 200 -alpha 0.95 -min_length 50 -result_path ../logs/abs_bert_cnndm
```
